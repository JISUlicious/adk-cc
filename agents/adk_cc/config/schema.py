...
FIELDS: list[Var] = [
    ...
    Var("ADK_CC_MODEL_DEFAULT_NAME", Tier.DEV, "Model",
        "Display name of the seeded registry endpoint (cosmetic).", default="default"),
    Var("ADK_CC_CODEX_STORE_DIR", Tier.ADVANCED, "Model: Codex",
        ...
        default_display="$DESKTOP_DATA or ~/.adk-cc"),
    ...
    Var("ADK_CC_CONTEXT_MAX_BYTES", Tier.ADVANCED, "Context",
        "Per-file cap for CLAUDE.md/CONTEXT.md injection (file cap, NOT the token ladder).",
    ...
    Var("ADK_CC_DAYTONA_CREATE_BACKOFF_BASE_S", Tier.ADVANCED, "Sandbox: Daytona",
        "Capacity-backoff initial delay.", default=0.5, parse=as_float),
    Var("ADK_CC_DAYTONA_CREATE_BACKOFF_CAP_S", Tier.ADVANCED, "Sandbox: Daytona",
        "Capacity-backoff per-sleep cap.", default=8.0, parse=as_float),
    ...
    Var("ADK_CC_CREDENTIAL_STORE_DIR", Tier.COMMON, "Credentials",
        "Secret store dir (required for encrypted_file).", default=None, parse=as_path),
    ...
    Var("ADK_CC_IDENTITY_DIR", Tier.ADVANCED, "Deployment", profile=Profile.WEB,
        ...
        default_display=".adk-cc/identity"),
    Var("ADK_CC_ADMIN_DATA_DIR", Tier.COMMON, "Deployment", profile=Profile.WEB,
        ...
        default_display="<cwd>/.adk-cc/admin-data"),
    ...
    Var("ADK_CC_AUDIT_LOG", Tier.COMMON, "Deployment",
        ...
        default_display="~/.adk-cc/audit.jsonl"),
    ...
    Var("ADK_CC_TASKS_DIR", Tier.ADVANCED, "Deployment",
        ...
        default_display="<workspace>/.adk-cc/tasks"),
    ...
    Var("ADK_CC_TASK_REMINDER_DEBUG", Tier.DEV, "Behavior",
        "Trace task-reminder fire decisions to stderr.", default=False, parse=as_bool),
    Var("ADK_CC_TASK_REMINDER_TURNS_SINCE_WRITE", Tier.DEV, "Behavior",
        "Reminder cadence (turns since last task write).", default=10, parse=as_int),
    Var("ADK_CC_TASK_REMINDER_TURNS_BETWEEN", Tier.DEV, "Behavior",
        "Reminder cadence (turns between nudges).", default=10, parse=as_int),
    Var("ADK_CC_TASK_REMINDER_OPEN_TURNS", Tier.DEV, "Behavior",
        "Reminder cadence (open-task turns).", default=3, parse=as_int),
    Var("ADK_CC_TASK_REMINDER_OPEN_BETWEEN", Tier.DEV, "Behavior",
        "Reminder cadence (open-task turns between).", default=2, parse=as_int),
    ...
    Var("ADK_CC_WEB_FETCH_PDF_MAX_BYTES", Tier.ADVANCED, "Behavior",
        "Max PDF fetch size.", default=10000000, parse=as_int),
