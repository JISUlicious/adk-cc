...
FIELDS: list[Var] = [
    ...
    Var("ADK_CC_SANDBOX_PIDS_LIMIT", Tier.ADVANCED, "Sandbox",
        "Container PID limit (docker + container backends).", default=512, parse=as_int),
    ...
    Var("ADK_CC_MEMORY_SYNTH", Tier.ADVANCED, "Memory & Wiki",
        "Consolidation synthesis: LLM distill unless 'deterministic' (latest-wins, "
        "no model). Only this step — autocapture/resolve have their own flags.",
