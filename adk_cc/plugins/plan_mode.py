...
PLAN_MODE_REMINDER = (
    ...
    "Explore/Plan sub-agents are still available. When you are confident in your\n"
    "plan and ready to execute, call `exit_plan_mode` with a brief summary of the\n"
    "plan; the user will resume normal mode.\n"
