...
async def _migrate(db_path: str, base_dir: str, *, dry_run: bool) -> dict:
    fss = FileSessionService(base_dir)
    con = sqlite3.connect(db_path)
    con.row_factory = sqlite3.Row

    stats = {"sessions": 0, "migrated": 0, "skipped": 0, "events": 0, "app_states": 0, "user_states": 0}
...
def main() -> int:
    ...
    stats = asyncio.run(_migrate(args.db, args.data, dry_run=args.dry_run))
    print(
